    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed animate-fade-in animate-delay-200">
          ...
          {/* Tech stack badges */}
          <div className="flex flex-wrap justify-center gap-3 animate-fade-in animate-delay-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in animate-delay-400">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm transition-all duration-medium hover:scale-105"
          ...
          {/* Social links */}
          <div className="flex justify-center gap-6 animate-fade-in animate-delay-400">
            <a 
